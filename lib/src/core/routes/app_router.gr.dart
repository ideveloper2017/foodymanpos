...
import '../../models/data/location_data.dart' as _i9;
import '../../models/data/order_data.dart' as _i10;
...
class SelectAddressRouteArgs {
  ...
  final _i9.LocationData? location;

  @override
  String toString() {
    return 'SelectAddressRouteArgs{key: $key, onSelect: $onSelect, location: $location}';
  }
}
